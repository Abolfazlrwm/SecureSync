...
[![Status](https://img.shields.io/badge/status-Phase_3_%E2%80%94_delta_sync-orange)]()

</div>

> ⚠️ **Project status:** Phase 1 (Filesystem Watcher), Phase 2 (Chunk
> Engine), and Phase 3 (Delta Synchronization) are implemented. The sync
> engine is still early — see [ROADMAP.md](ROADMAP.md) for what's next.
