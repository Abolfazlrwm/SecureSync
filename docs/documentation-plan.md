...
introducing a new port. ADR `0010`, added in the Phase 3.5
reconciliation, records that `ChunkRepository`/`FileChunkRepository`
already is the project's persistent manifest repository, and why no
second `JsonManifestRepository` component was introduced alongside it.
